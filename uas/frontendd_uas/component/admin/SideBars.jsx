                            ...
                            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                ...
                                <li>
                                    ...
                                    <ul className="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                        ...
                                        <li className="w-100">
                                            <a href="#" className="nav-link px-0"> <span className="d-none d-sm-inline">Data Vaksinasi Mahasiswa</span> </a>
                                        </li>
                                        </Link>
                                        <Link href="/admin/createvaksin">
                                        <li>
                                            <a href="#" className="nav-link px-0"> <span className="d-none d-sm-inline">Tambah data vaksinasi Mahasiswa</span></a>
                                        </li>
                                        </Link>
                                    </ul>
                                </li>
